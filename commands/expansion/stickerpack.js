 ...
 *        a. the official Pinterest API v5 — only if PINTEREST_ACCESS_TOKEN is
 *           set (optional; skipped automatically if the token is rejected),
 ...
 *
 * ENV (optional): PINTEREST_ACCESS_TOKEN — never hardcode it in this file.
