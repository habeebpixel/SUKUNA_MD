...
function buildInstagramGenAILookupContent(username, profile = {}) {
    ...
    const avatar = isHttpUrl(profile.avatar) ? profile.avatar : `https://unavatar.io/instagram/${encodeURIComponent(username)}`;
        ...
        sections: [
            {
                view_model: {
                    primitives: [{
                        ...
                        subtitle: 'By Pasqua Tech',
                        secondary_subtitle: '',
                        image: { url: avatar, mime_type: 'image/png' },
                        entity_id: '123456',
                        entity_url: 't.me/devpasqua',
                        entity_type: 'WEBSITE',
...
module.exports = {
    ...
    async execute({ sock, msg, from, reply, args }) {
        ...
        try {
            ...
            // Only the GenAI "Instagram lookup" chip sends — the link-preview
            // and HTML-sheet cards are deliberately not sent here anymore.
            try {
