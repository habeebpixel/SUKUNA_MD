...
//
// `limit` defaults to MAX_RESULTS (6) so .pint behaves exactly as before.
// .stickerpack (commands/expansion/stickerpack.js) reuses this same function
// through `_private.findImages` and passes a larger limit.
async function findImages(query, limit = MAX_RESULTS) {
